...
def get_news_data():
    ...
    world_articles1 = 'http://api.nytimes.com/svc/search/v2/articlesearch.json?fq=section_name:(%22World%22)%20AND%20source:(%22The%20New%20York%20Times%22)&fl=web_url,headline,keywords,byline,multimedia,pub_date&sort=newest&api-key=' + article_api
